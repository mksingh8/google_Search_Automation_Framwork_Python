...
class Test_002_google_multi_search:
    ...
    path = '/home/manish/Documents/Programming/Python/pythonProject/google_Search_Automation_Framwork_Python' \
           '/Test_Data/auto_test_data.xlsx '
    screenshot = '/home/manish/Documents/Programming/Python/pythonProject/google_Search_Automation_Framwork_Python' \
                 '/Screenshots '
            ...
            for row in range(2, self.rows + 1):
                ...
                if 'Search' in title:
                    ...
                    if exp == 'pass':
                        ...
                        test_status.append("fail")
                        self.driver.save_screenshot(self.screenshot + __name__ + '.png')
                        assert False
